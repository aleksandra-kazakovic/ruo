...
public class OnStartUpApplication implements ApplicationListener<ContextRefreshedEvent> {
  ...
  private static String getListOfModels = "getListOfModels";
  ...
  public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
    try {
      ...
      String host = getHostPostOfServer();
      ...
      String url = hostname + getListOfModels;
      String response = restTemplate.getForObject(url, String.class);
      ObjectMapper mapper = new ObjectMapper();
      List<MlModel> participantJsonList = mapper.readValue(response, new TypeReference<List<MlModel>>(){});

      FileStorage.addFiles(participantJsonList);
